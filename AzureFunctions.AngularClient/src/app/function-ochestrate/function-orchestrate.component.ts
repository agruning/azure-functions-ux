...
@Component({
    selector: 'function-orchestrate',
    templateUrl: './function-orchestrate.component.html',
    styleUrls: ['./function-orchestrate.component.css'],
    inputs: ['viewInfoInput']
})
export class FunctionOrchestrateComponent {
